...
function norm_action($s){
    ...
    $s = str_replace([chr(13),chr(10),chr(9),chr(160)], '', $s); 
    $s = trim($s);
  ...
  <div id="clan-logs" class="clan-messages-box">
    ...
    <?php else: ?>
      <?php foreach ($rows as $r):
        ...
        $kicked   = isset($d['kicked_user_id']) ? $getUser($d['kicked_user_id']) : null; 
        $left     = isset($d['left_user_id']) ? $getUser($d['left_user_id']) : null;     
