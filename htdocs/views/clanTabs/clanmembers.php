...
<style>
.clanmembers-section-title {
    max-width: 1100px;
    margin: 0 auto 18px auto;
    padding-left: 10px;
    box-sizing: border-box;
}
.stat-left img[src$="ranks/23.png"] {
    transform: translateX(-5px);
}
</style>

<div class="box">
    <div class="title clanmembers-section-title">Clan members</div>
    <div id="clan-members">
...
<?php if ($can_review) { ?>
    <div class="box">
        <div class="title clanmembers-section-title">Membership Requests</div>
