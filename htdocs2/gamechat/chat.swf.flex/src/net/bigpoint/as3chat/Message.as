        ...
        public function getHTML():String
        {
            ...
            if (this.messageType != TYPE_USER) 
            {
                if (this.messageType != TYPE_MODERATOR) 
                {
                    if (this.messageType != TYPE_SYSTEM) 
                    {
                            ...
                            if (this.messageType != TYPE_YOU_WHISPER) 
                            {
                                if (this.messageType != TYPE_INVITE) 
                                {
                                    if (this.messageType != TYPE_HELP) 
                                    {
                                        ...
                                        {
                                            loc1 = "<span class=\'system\'>" + this.message + "</span><br>";
                                        }
                                    }
                                    else 
                                    {
                        ...
                        else 
                        {
                            ...
                            loc1 = "<span class=\'system\'><a href=\"event:USER|" + loc3[0] + "\">" + loc3[1] + "</a></span><span class=\'text\'>" + this.message + "</span><br>";
                        }
                    }
                    else 
                    {
                ...
                else 
                {
                    ...
                    if (this.adminLevelId == 2) 
                    {
                        loc5 = "vip";
                    }
                    if (this.adminLevelId == 3) 
                    {
                        loc5 = "supporter";
                    }
                    loc1 = "<span class=\'" + loc5 + "\'><a href=\"event:USER|" + this.username + "\">" + loc2 + ": </a>" + this.message + "</span><br>";
                }
            }
            else 
            {
                loc1 = "<span class=\'sender\'><a href=\'event:USER|" + this.username + "\'>" + loc2 + ": </a>" + "</span><span class=\'text\'>" + this.message + "</span><br>";
            }
            return loc1;
        }
